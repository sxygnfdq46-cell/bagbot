...
"""Fusion Reactor: deterministic fusion of normalized signals."""
...
def fuse_signals(signals: Iterable[NormalizedSignal], config: FusionConfig = DEFAULT_CONFIG) -> FusionResult:
    """Combine normalized signals into a deterministic fusion result."""
...
__all__ = ["fuse_signals", "FusionConfig", "DEFAULT_CONFIG"]
