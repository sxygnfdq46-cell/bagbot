"""Lightweight entrypoint for scheduling the daily trading cycle."""
...
try:
    ...
    class DailyCycleScheduler:  # type: ignore
        """Test stub when worker.scheduler import fails."""
...
async def run_daily_cycle(dry_run: bool = False, log_dir: str | None = None):  # type: ignore
    """Trigger the scheduler daily cycle, optionally in dry-run mode."""
    if dry_run:
